...
class BranchService {
  ...
  void _listenDynamicLinks() {
    _streamSubscription = FlutterBranchSdk.listSession().listen((data) {
      ...
      if (data.containsKey('+clicked_branch_link') &&
        ...
        // Aquí puedes emitir los datos procesados o manejarlos según necesites
  ...
  BranchUniversalObject _createBranchUniversalObject({
    ...
    //final dateString = DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now());
  ...
  void _handleDeepLinkData(Map<String, dynamic> linkData) {
    // Implementa la lógica para manejar los datos del deep link
    if (kDebugMode) {
